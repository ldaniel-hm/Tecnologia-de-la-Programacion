...
class List:
    ...
    _size_min: int = 10  # El tamaño más pequeño que tendrá cualquier array
    ...
    def _insert_item(self, pos: int, value: object) -> None:
        ...
        new_array = self._list  # Una inicialización como otra cualquiera.
        if self._pos + 1 == self._size:  # Array lleno, duplicamos el tamaño.
            self._size = self._size * 2
            new_array = Array1D(self._size)
        self._pos = self._pos + 1
        for i in range(self._pos, pos, -1):  # Copiamos desde el final hasta pos+1
            new_array[i] = self._list[i - 1]
        new_array[pos] = value  # Añadimos en pos el nuevo valor.
        for i in range(pos - 1, -1, -1):  # Copiamos desde pos-1 hasta el primero.
