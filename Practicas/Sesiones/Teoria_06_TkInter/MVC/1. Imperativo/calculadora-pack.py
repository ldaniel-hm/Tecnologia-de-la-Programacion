...
frame1.pack()
tk.Entry(frame1, width=8, textvariable=sum1).pack(side=tk.LEFT)
tk.Label(frame1, text="+").pack(side=tk.LEFT)
tk.Entry(frame1, width=8, textvariable=sum2).pack(side=tk.LEFT)
tk.Label(frame1, text="=").pack(side=tk.LEFT)
tk.Entry(frame1, width=8, state="readonly", textvariable=suma_total).pack(side=tk.LEFT)
