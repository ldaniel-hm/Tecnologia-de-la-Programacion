...
class Bag:
    ...
    def __contains__(self, item: object) -> bool:
        """
        Indica si el elemento item se encuentra en el bag.
        Nota: Si invoca cuando se usa 'in' o 'not in'

        :param item: El index a buscar en el bag
        :return: Retorna True si está contenido y False si no está contenido.
        """
        # Se usa 'in' de la lista: se delega en __contains__ de la clase list de Python.
    ...
    def __iter__(self):
        ...
        # Invoca al creador de iteradores de la lista.
