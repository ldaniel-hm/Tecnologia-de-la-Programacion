...
Ejemplo de uso del TDA Fecha usando la clase Positivo
Observa que el código de prueba es el mismo que
el TDA Fecha usando enteros.
...
Da igual si el tipo Fecha usa enteros o si se usan el tipo Positivo
"""

from fecha_positivo import Fecha
