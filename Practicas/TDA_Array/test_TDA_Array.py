...
Ejemplo de uso del TDA Array
"""



from TDAArrayPythonList import Array1D, Array2D, Matrix  # Arrays con listas de Python
...
def test_array2d():
    ...
    print("Test get()",
          [mi_array[i, j] for i in range(mi_array.num_rows()) for j in range(mi_array.num_cols(i))])  # Check get_item
...
def test_matrix():
    ...
    for row in range(matrix.num_rows()):
        for col in range(matrix.num_cols(row)):
