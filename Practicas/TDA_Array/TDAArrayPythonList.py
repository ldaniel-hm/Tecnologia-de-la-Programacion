...
class Array1D:
    ...
    def __init__(self, size: int):
        """
        Inicializa un array 1D con la capacidad de size elementos.
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        assert isinstance(index, int) and 0 <= index < len(self), "Array Index Out Of Bounds Exception"
...
class _Array_Iterator:
    ...
    def __init__(self, the_array: Array1D):
        """
        ...
        """
        self._arrayRef: Array1D = the_array
        self._pos: int = 0
...
class Array2D:
    """
    Implements the TDA Array 2D using List
    """
    ...
    def __getitem__(self, index_tuple: tuple) -> Any:
        """
    ...
    def __setitem__(self, index_tuple: tuple, value: Any) -> None:
        """
    ...
    def clear(self, value: Any) -> None:
        ...
        for row in self._the_rows:  # type: Array1D
            row.clear(value)
...
class _Array2D_Iterator:
    ...
    def __init__(self, the_array: Array2D) -> None:
        ...
        """
        self._array_ref: Array2D = the_array
        self._pos_row = 0
        self._pos_col = 0
    ...
    def __next__(self) -> object:
        ...
        :rtype: object
        """
        if self._pos_row < self._array_ref.num_rows():
            element = self._array_ref[self._pos_row, self._pos_col]
            self._pos_col = (self._pos_col + 1) % self._array_ref.num_cols(self._pos_row)
            if self._pos_col == 0:
                self._pos_row = self._pos_row + 1
            return element
